...
// - get the data and show details on the page 
// - useGetCourseByIdQuery - fetch the data using this api 
    ...
    <div className="max-w-7xl mx-auto p-4">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1 md:w-3/5 h-fit rounded-lg shadow-lg p-4">
          <div>
            <video
              src={currentLecture?.videoUrl || initialLecture.videoUrl}              controls
